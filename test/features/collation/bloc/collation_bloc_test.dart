...
void main() {
  group('CollationBloc', () {
    ...
    test('初始状态应该为默认值', () {
      expect(bloc.state, const CollationState());
    ...
    blocTest<CollationBloc, CollationState>(
      ...
      expect: () => [
        const CollationState(text2: '处处闻啼鸟'),
      ],
    );
    ...
    blocTest<CollationBloc, CollationState>(
      ...
      expect: () => [
        const CollationState(ignorePunctuation: false),
      ],
    );
    ...
    blocTest<CollationBloc, CollationState>(
      ...
      expect: () => [
        const CollationState(ignoreTraditional: false),
      ],
    );
